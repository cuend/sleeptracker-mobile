...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 2560);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 124);
/* harmony import */ var _sleepiness_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sleepiness.page */ 6139);
...
SleepinessPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
  imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
  exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule]
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ 2508);
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ionic/angular */ 3819);
/* harmony import */ var _sleepiness_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sleepiness-routing.module */ 7644);
/* harmony import */ var _sleepiness_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sleepiness.page */ 6139);
...
SleepinessPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
  imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _sleepiness_routing_module__WEBPACK_IMPORTED_MODULE_0__.SleepinessPageRoutingModule],
...
/* harmony import */ var _sleepiness_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_sleepiness_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/core */ 2560);
/* harmony import */ var _data_stanford_sleepiness_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../data/stanford-sleepiness-data */ 4201);
/* harmony import */ var _services_sleep_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/sleep.service */ 5403);
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ 3819);
...
let SleepinessPage = class SleepinessPage {
  ...
  ngOnInit() {}
  onSliderChange(e) {
    this.currSliderValue = e.detail.value;
    if (this.hasBeenResest) {
      this.currStanfordValue = "";
      this.hasBeenResest = false;
    } else {
      this.currStanfordValue = _data_stanford_sleepiness_data__WEBPACK_IMPORTED_MODULE_3__.StanfordSleepinessData.ScaleValues[this.currSliderValue];
    }
  }
  onSleepinessLog(e) {
    this.sleepService.logSleepinessData(new _data_stanford_sleepiness_data__WEBPACK_IMPORTED_MODULE_3__.StanfordSleepinessData(this.currSliderValue, new Date(), this.currNoteString));
    this.inputBox = "";
    this.rangeSlider = 1;
    this.hasBeenResest = true;
  }
  onNoteInputChange(e) {
    this.currNoteString = e.target.value;
  }
  inputTextCounterFormatter(inputLength, maxLength) {
  ...
  static #_ = this.ctorParameters = () => [{
    type: _services_sleep_service__WEBPACK_IMPORTED_MODULE_4__.SleepService
  }, {
    type: _ionic_angular__WEBPACK_IMPORTED_MODULE_5__.ToastController
  }];
};
SleepinessPage = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
  selector: 'app-sleepiness',
  template: _sleepiness_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__,
  styles: [(_sleepiness_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2___default())]
})], SleepinessPage);
...
"use strict";
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title>Sleepiness</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<style>\n\n  ion-row {\n  height: 26%;\n  width: 100%;\n  align-items: center;\n  }\n\n  .design {\n    position: center;\n    width: 90%;\n    height: 90%;\n    margin-left: auto;\n    margin-right: auto;\n  }\n\n  .notice {\n    text-decoration-color: lightslategray;\n    text-align: left;\n    font-size: small;\n    justify-content: center;\n  }\n\n  ion-range {\n  --knob-size: 20px;\n  }\n  \n  </style>\n\n<ion-content>\n\n  <ion-grid class=\"design\">\n    <ion-row>\n      <ion-col>\n        <h1 class=\"mb-10\">Feeling Sleepy?</h1>\n        <ion-label>Sleepiness</ion-label>\n      </ion-col>\n    </ion-row>\n\n    <ion-row>\n      <ion-range [(ngModel)]=\"rangeSlider\" [ticks]=\"true\" [snaps]=\"true\" [pin]=\"true\" [min]=\"1\" [max]=\"7\" (ionChange)=\"onSliderChange($event)\">\n        <div slot=\"start\">1</div>\n        <div slot=\"end\">7</div>\n      </ion-range>\n      <ion-row>\n        <ion-label>{{currStanfordValue}}</ion-label>\n      </ion-row>\n    </ion-row>\n\n    <ion-row class=\"ion-justify-content-center\">\n      <ion-item id=\"custom-item\" counter=\"true\" [counterFormatter]=\"inputTextCounterFormatter\">\n        <ion-label position=\"floating\">Sleepiness Notes (Optional)</ion-label>\n        <ion-input [(ngModel)]=\"inputBox\" (ionChange)=\"onNoteInputChange($event)\" maxlength=\"50\"></ion-input>\n      </ion-item>\n    </ion-row>\n\n    <ion-row class=\"ion-justify-content-center\">\n        <ion-button shape=\"round\" color=\"success\" (click)=\"onSleepinessLog();sleepyToast('top')\">Log Sleepiness</ion-button>\n    </ion-row>\n  </ion-grid>\n\n\n</ion-content>";
