...
class OvernightSleepData extends _sleep_data__WEBPACK_IMPORTED_MODULE_0__.SleepData {
  ...
  getDateStringForGraph() {
    let d = this.sleepStart.toLocaleDateString('en-US', {
      weekday: 'long',
      month: 'long',
      day: 'numeric'
    }).split(" ");
...
class StanfordSleepinessData extends _sleep_data__WEBPACK_IMPORTED_MODULE_0__.SleepData {
  ...
  getDateStringForGraph() {
    let d = this.loggedAt.toLocaleDateString('en-US', {
      weekday: 'long',
      month: 'long',
      day: 'numeric'
    }).split(" ");
...
let SleepService = class SleepService {
  ...
  static #_ = this.LoadDefaultData = true;
  static #_2 = this.AllSleepData = [];
  static #_3 = this.AllOvernightData = [];
  static #_4 = this.AllSleepinessData = [];
  addDefaultData() {
...
SleepService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
  providedIn: 'root'
})], SleepService);
...
var isValid = __webpack_require__(/*! ./is-valid */ 8908);
