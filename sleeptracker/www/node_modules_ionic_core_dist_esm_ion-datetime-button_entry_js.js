...
const DatetimeButton = class {
  constructor(hostRef) {
    ...
    this.setDateTimeText = () => {
      ...
      const use24Hour = (0,_data_64bc531e_js__WEBPACK_IMPORTED_MODULE_6__.J)(locale, hourCycle);
     ...
     */
    this.waitForDatetimeChanges = /*#__PURE__*/(0,_Users_davidcuen_Desktop_Computer_Science_INF_133_a4_sleeptracker_INF133_sleeptracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        datetimeEl
      } = _this;
      if (!datetimeEl) {
    ...
    this.presentOverlay = /*#__PURE__*/function () {
      var _ref3 = (0,_Users_davidcuen_Desktop_Computer_Science_INF_133_a4_sleeptracker_INF133_sleeptracker_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev, needsPresentationChange, triggerEl) {
        const {
          overlayEl
        } = _this;
        if (!overlayEl) {
